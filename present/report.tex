...
\begin{frame}
	...
	\begin{itemize}
		\item<1-> Изучить теорию Солнечных нейтрино.
		...
		смешивания.
		\item<3-> Проанализировать полученные данные.
		\item<4-> Оценить степень влияния вариации параметров на значение вероятности 
...
\begin{frame}
	...
	\begin{itemize}
		\item<1-> Написаны сценарии для генерации и анализа данных.
		Сценарии --- это коды написанный для bash-оболочки. Они используются в работе для 
		автоматизации процесса генерации данных и их анализа.
		\item<2-> Воспроизводимость?
		\item<3-> Пример работы сценариев
	\end{itemize}
