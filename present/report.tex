...
\begin{frame}
	...
	\begin{itemize}
		...
		\item<2-> Провести численные расчёты вероятности выживания или перехода нейтрино 
		для Солнечной модели при вариации параметров профиля плотности и углов 
		смешивания.
		\item<3-> Провести расчёты для случая астрофизического нейтрино, проходящего сквозь 
		вещество.
		\item<4-> Проанализировать полученные данные.
		\item<5-> Оценить степень влияния вариации параметров на значение вероятности 
		выживания или перехода нейтрино.
...
\begin{frame}
	...
	\begin{itemize}
		\item<1-> Написаны и доработаны сценарии для генерации и анализа данных.
		\item<2-> Частично проведены расчёты для астрофизического нейтрино проходящего 
		сквозь Солнце.
	\end{itemize}
...
\begin{frame}
	...
	\begin{itemize}
		\item<1-> Сценарий --- это небольшая программа, которая выполняет конкретную задачу.
		\item<2-> Сценарий для генерации данных был разработан для автоматизации процесса 
		расчёта с вариацией параметров как среды, так и нейтрино.
		На данный момент сценарий готов для применения и используется в работе.
	\end{itemize}
